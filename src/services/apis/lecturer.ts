...
const generateMockResponses = (
  ...
  const mockResponses: UserResponse[] = [
    ...
    },
    {
      ...
      content:
        "[Audio Recording] - The student discussed their first day at university, describing the excitement and nervousness they felt, the new friends they made, and how this experience shaped their academic journey.",
      score: null,
    ...
    },
    {
      ...
      content:
        "Social media has revolutionized the way we communicate and share information. On the positive side, it allows instant global connectivity, enabling people to maintain relationships across distances and share experiences in real-time. However, it also presents challenges such as privacy concerns, addiction, and the spread of misinformation...",
      score: 7.0,
    ...
    },
    {
      ...
      content:
        "[Audio Recording] - The student eloquently discussed online learning platforms, digital resources, and how COVID-19 accelerated the adoption of educational technology, while also addressing the digital divide issue.",
      score: null,
    ...
    },
    {
      ...
      questionId: 106,
      questionText:
        "Write a letter to your local government about environmental issues.",
      content:
    ...
    },
    {
      ...
      content:
        "[Audio Recording] - The student described their dream of becoming a marine biologist, explaining their passion for ocean conservation and the desire to contribute to environmental protection through scientific research.",
      score: 9.0,
    ...
    queryFn: async () => {
      try {
        ...
        if ("content" in response) {
          return response as unknown as UserResponsesPage;
        }
